...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'About Us Hero Block settings', 'rmbt_premium_theme_1' ),
		'id' => 'settings_about us hero block',
		'desc' => esc_html__( 'Settings about us hero block site', 'rmbt_premium_theme_1' ),
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'About Us Hero Block Title', 'rmbt_premium_theme_1' ),
				'default' => esc_html__( 'Meet the Founder', 'rmbt_premium_theme_1' ),
			),
			array(
				'id' => 'rmbt-about_us_hero_block_subtitle',
				'type' => 'text',
				'title' => esc_html__( 'About Us Hero Block Subtitle', 'rmbt_premium_theme_1' ),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Hero Block Image', 'rmbt_premium_theme_1' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'About Us Hero Block Alt Image', 'rmbt_premium_theme_1' ),
