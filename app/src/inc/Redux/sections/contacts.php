	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__( 'Contacts Page settings', 'rmbt_premium_theme_1' ),
				'indent' => true
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Contacts Page Title', 'rmbt_premium_theme_1' ),
				'default' => esc_html__( 'Let`s Chat', 'rmbt_premium_theme_1' ),
			),

			array(
				'id' => 'rmbt-contacts-page-map-iframe',
				'type' => 'textarea',
				'title' => esc_html__( 'Contacts Page Link to Map', 'rmbt_premium_theme_1' ),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Contacts Page Second Title', 'rmbt_premium_theme_1' ),
				'default' => esc_html__( 'Get in Touch', 'rmbt_premium_theme_1' ),
			),
			array(
				'id' => 'rmbt-contacts-page-subtitle-2',
				'type' => 'text',
				'title' => esc_html__( 'Contacts Page Second Subtitle', 'rmbt_premium_theme_1' ),
				'default' => esc_html__( 'We guarantee to get back to you within 24 hours', 'rmbt_premium_theme_1' ),
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Contacts Form Title', 'rmbt_premium_theme_1' ),
				'default' => esc_html__( 'Get in Touch', 'rmbt_premium_theme_1' ),
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Contacts Form Subtitle', 'rmbt_premium_theme_1' ),
				'default' => esc_html__( 'Fill out the form below and our team will get back to you in less than 24 hours.', 'rmbt_premium_theme_1' ),
			),
