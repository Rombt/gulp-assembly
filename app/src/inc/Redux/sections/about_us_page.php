...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'About Us Section settings', 'rmbt_premium_theme_1k' ),
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'About Us Title', 'rmbt_premium_theme_1k' ),
			...
			array(
				...
				'type' => 'textarea',
				'title' => esc_html__( 'About Us text', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( 'We`re the roofing contractors Calgary can count on doing the job right. premium_theme_1k has extensive experience in roofing and exteriors for single-family homes and commercial properties in Calgary, Alberta, including 24/7 emergency roofing services. We work closely with property owners like you to find a perfect solution for your roofing and exterior needs.', 'rmbt_premium_theme_1k' ),
			),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Block Background Image', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Gallery First Image', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Gallery Second Image', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Gallery Third Image', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Gallery Forth Image', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Description for forth picture', 'rmbt_premium_theme_1k' ),
			),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Gallery Fifth Image', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Description for fifth picture', 'rmbt_premium_theme_1k' ),
			),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'About Us Gallery Sixth Image', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				'default' => array(
					'url' => '/assets/img/about_us-block/Frame 1000003714.jpg'
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Description for sixth picture', 'rmbt_premium_theme_1k' ),
			),
