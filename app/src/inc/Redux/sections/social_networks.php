...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Social Networks Settings', 'rmbt_premium_theme_1k' ),
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__( 'Facebook section', 'rmbt_premium_theme_1k' ),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rmbt_premium_theme_1k'),
				'indent' => true
			),
			array(
				'id' => 'rmbt-social-networks_fb-link',
				'type' => 'text',
				'title' => esc_html__( 'Facebook link', 'rmbt_premium_theme_1k' ),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'Facebook icon', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Image description for FaceBook icon', 'rmbt_premium_theme_1k' ),
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__( 'Instagram section', 'rmbt_premium_theme_1k' ),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rmbt_premium_theme_1k'),
				'indent' => true
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Instagram link', 'rmbt_premium_theme_1k' ),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'Instagram icon', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Image description for instagram icon', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( '', 'rmbt_premium_theme_1k' ),
			),
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__( 'Youtube section', 'rmbt_premium_theme_1k' ),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rmbt_premium_theme_1k'),
				'indent' => true
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Youtube link', 'rmbt_premium_theme_1k' ),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'Youtube icon', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Image description for youtube icon', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( '', 'rmbt_premium_theme_1k' ),
			),
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__( 'Twitter section', 'rmbt_premium_theme_1k' ),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rmbt_premium_theme_1k'),
				'indent' => true
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Twitter link', 'rmbt_premium_theme_1k' ),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'Twitter icon', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Image description for twitter icon', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( '', 'rmbt_premium_theme_1k' ),
			),
			...
			array(
				...
				'type' => 'section',
				'title' => esc_html__( 'Linkedin section', 'rmbt_premium_theme_1k' ),
				// 'subtitle' => esc_html__('Enter phone number and set his name', 'rmbt_premium_theme_1k'),
				'indent' => true
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Linkedin link', 'rmbt_premium_theme_1k' ),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => esc_html__( 'Linkedin icon', 'rmbt_premium_theme_1k' ),
				'compiler' => 'true',
				'preview_size' => 'full',
				// 'default' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Image description for linkedin icon', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( '', 'rmbt_premium_theme_1k' ),
			),
