...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Our Projects settings', 'rmbt_premium_theme_1k' ),
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'Our Projects Title', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( 'Our Projects', 'rmbt_premium_theme_1k' ),
			),
			array(
				'id' => 'rmbt-our-projects_section-subtitle-1',
				'type' => 'text',
				'title' => esc_html__( 'Our Projects First Subtitle', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( 'The best advertising for us is to show our Metal Roofs to you', 'rmbt_premium_theme_1k' ),
			),
			array(
				'id' => 'rmbt-our-projects_section-subtitle-2',
				'type' => 'text',
				'title' => esc_html__( 'Our Projects Second Subtitle', 'rmbt_premium_theme_1k' ),
				'default' => esc_html__( 'The best advertising for us is to show our Metal Roofs to you', 'rmbt_premium_theme_1k' ),
			),
			...
			// 	'type' => 'media',
			// 	'url' => true,
			// 	'title' => esc_html__('Our Projects Gallery First Image', 'rmbt_premium_theme_1k'),
			// 	'compiler' => 'true',
			// 	'preview_size' => 'full',
			// 	'default' => array(
			...
			// 	'type' => 'media',
			// 	'url' => true,
			// 	'title' => esc_html__('Our Projects Gallery Second Image', 'rmbt_premium_theme_1k'),
			// 	'compiler' => 'true',
			// 	'preview_size' => 'full',
			// 	'default' => array(
			...
			// 	'type' => 'media',
			// 	'url' => true,
			// 	'title' => esc_html__('Our Projects Gallery Third Image', 'rmbt_premium_theme_1k'),
			// 	'compiler' => 'true',
			// 	'preview_size' => 'full',
			// 	'default' => array(
